 ...
 */
public class AutoScrollViewPagerOld extends ViewPager {
    ...
    public AutoScrollViewPagerOld(Context paramContext) {
        super(paramContext);
        init();
    }

    public AutoScrollViewPagerOld(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<AutoScrollViewPagerOld> autoScrollViewPager;

        public MyHandler(AutoScrollViewPagerOld autoScrollViewPager) {
            this.autoScrollViewPager = new WeakReference<AutoScrollViewPagerOld>(autoScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    AutoScrollViewPagerOld pager = this.autoScrollViewPager.get();
                    if (pager != null) {
